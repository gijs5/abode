...
$this->Html->addCrumb('Project action phasing');
?>
<div class="projectsteps index">
	...
	<ul class="page-menu">
		<li><?php echo $this->Html->link('Add phase in '.$projectstage['Stage']['name'], array('action'=>'add', $projectstage['Projectstage']['id'])) ?>
	</ul>
	...
	<div id="projectphases" class="coll-left">
		...
		<?php if (isset($projectstage['Projectphase']) && !empty($projectstage['Projectphase'])): ?>
